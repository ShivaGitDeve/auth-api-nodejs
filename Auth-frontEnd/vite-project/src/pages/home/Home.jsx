...
const HomePage = () => {
  ...
  // Logic me zero changes - exactly as you requested
  if (user) {
    return <Navigate to="/dashboard" />;
  }

  return (
    // Main Wrapper with dark/modern gradient and full height
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-900 to-slate-900 flex flex-col font-sans relative overflow-hidden">
      {/* Background Glow Effects (Mast look ke liye) */}
      ...
      <main className="flex-1 max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center px-6 md:px-12 z-10 gap-12 lg:gap-20 w-full pb-12">
        {/* Left Side: Content */}
        <div className="text-left text-white max-w-xl w-full flex flex-col mt-8 lg:mt-0">
    ...
    transition-all duration-300"
        ...
        {/* Right Side: Image */}
        <div className="w-full max-w-lg lg:max-w-xl relative mt-10 lg:mt-0">
          {/* Image back-glow */}
